...
/**
 * Server class will make the server socket and open it for incoming connections
 * extends Thread
 */
...
public class Server extends Thread{
	 ...
	 */
	public Server() throws IOException{port = 8080; server = new ServerSocket(port);}
	public Server(int port) throws IOException{this.port = port; this.server = new ServerSocket(this.port);}
